...
- Paraglide JS is a compiler-first internationalization library. <https://paraglidejs.com/llms.txt>
- Do not edit src/db/auth-schema.ts since it's generated by better-auth.
